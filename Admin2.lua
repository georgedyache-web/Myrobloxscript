...
-- 1. ПОЛНОЦЕННЫЙ ПОЛЕТ (По направлению камеры)
local flying = false
local flySpeed = 50
CreateButton("Fly: Camera Mode", UDim2.new(0.05, 0, 0.05, 0), Color3.fromRGB(50, 50, 50), function()
    flying = not flying
...
-- 2. АДМИН-ЧАТ (Команды :speed, :jump, :re)
